/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxresult.h,v 1.51.2.3.2.5 2011/10/14 02:23:02 shuohuang Exp $
 *
...
#define SS_FMT  28   /* Format/Codec detailed error */
...
#define HXR_WM_OPL_NOT_ALLOWED         MAKE_HX_RESULT(1,SS_GLO,37)                 // 80040025
...
#define HXR_REQUEST_FIRST_FRAME         MAKE_HX_RESULT(1,SS_GLO,42)                 // 80040030
...
#define HXR_NO_MORE_FILES               MAKE_HX_RESULT(1,SS_FIL,18)                 // 80040092
#define HXR_READ_ERROR                  MAKE_HX_RESULT(1,SS_FIL,19)                 // 80040093
#define HXR_FULL_DOWNLOAD_NEEDED        MAKE_HX_RESULT(1,SS_FIL,20)                 // 80040094
#define HXR_RECORD_NORENDER             MAKE_HX_RESULT(1,SS_FIL,21)                 // 80040095
...
#define HXR_DISCONTINUITY               MAKE_HX_RESULT(0,SS_FIL,27)		    // 0004009B
#define HXR_RATE_SWITCHING              MAKE_HX_RESULT(0,SS_FIL,28)		    // 0004009C
...
#define HXR_PROTOCOL_DOES_NOT_SUPPORT_DATATYPE       MAKE_HX_RESULT(1,SS_PRT,24)    // 800400d8

/* Protocol Errors (RTSP and maybe HTTP) */
#define HXR_PE_BAD_REQUEST                           MAKE_HX_RESULT(1,SS_RTSP,0)    // 80040680
#define HXR_PE_UNAUTHORIZED                          MAKE_HX_RESULT(1,SS_RTSP,1)    // 80040681
#define HXR_PE_PAYMENT_REQUIRED                      MAKE_HX_RESULT(1,SS_RTSP,2)    // 80040682
#define HXR_PE_FORBIDDEN                             MAKE_HX_RESULT(1,SS_RTSP,3)    // 80040683
#define HXR_PE_NOT_FOUND                             MAKE_HX_RESULT(1,SS_RTSP,4)    // 80040684
#define HXR_PE_METHOD_NOT_ALLOWED                    MAKE_HX_RESULT(1,SS_RTSP,5)    // 80040685
#define HXR_PE_NOT_ACCEPTABLE                        MAKE_HX_RESULT(1,SS_RTSP,6)    // 80040686
#define HXR_PE_PROXY_AUTHENTICATION_REQUIRED         MAKE_HX_RESULT(1,SS_RTSP,7)    // 80040687
#define HXR_PE_REQUEST_TIMEOUT                       MAKE_HX_RESULT(1,SS_RTSP,8)    // 80040688
#define HXR_PE_GONE                                  MAKE_HX_RESULT(1,SS_RTSP,9)    // 80040689
#define HXR_PE_LENGTH_REQUIRED                       MAKE_HX_RESULT(1,SS_RTSP,10)    // 8004068a
#define HXR_PE_PRECONDITION_FAILED                   MAKE_HX_RESULT(1,SS_RTSP,11)    // 8004068b
#define HXR_PE_REQUEST_ENTITY_TOO_LARGE              MAKE_HX_RESULT(1,SS_RTSP,12)    // 8004068c
#define HXR_PE_REQUESTURI_TOO_LARGE                  MAKE_HX_RESULT(1,SS_RTSP,13)    // 8004068d
#define HXR_PE_UNSUPPORTED_MEDIA_TYPE                MAKE_HX_RESULT(1,SS_RTSP,14)    // 8004068e
#define HXR_PE_PARAMETER_NOT_UNDERSTOOD              MAKE_HX_RESULT(1,SS_RTSP,15)    // 8004068f
#define HXR_PE_CONFERENCE_NOT_FOUND                  MAKE_HX_RESULT(1,SS_RTSP,16)    // 80040690
#define HXR_PE_NOT_ENOUGH_BANDWIDTH                  MAKE_HX_RESULT(1,SS_RTSP,17)    // 80040691
#define HXR_PE_SESSION_NOT_FOUND                     MAKE_HX_RESULT(1,SS_RTSP,18)    // 80040962
#define HXR_PE_METHOD_NOT_VALID_IN_THIS_STATE        MAKE_HX_RESULT(1,SS_RTSP,19)    // 80040693
#define HXR_PE_HEADER_FIELD_NOT_VALID_FOR_RESOURCE   MAKE_HX_RESULT(1,SS_RTSP,20)    // 80040694
#define HXR_PE_INVALID_RANGE                         MAKE_HX_RESULT(1,SS_RTSP,21)    // 80040695
#define HXR_PE_PARAMETER_IS_READONLY                 MAKE_HX_RESULT(1,SS_RTSP,22)    // 80040696
#define HXR_PE_AGGREGATE_OPERATION_NOT_ALLOWED       MAKE_HX_RESULT(1,SS_RTSP,23)    // 80040697
#define HXR_PE_ONLY_AGGREGATE_OPERATION_ALLOWED      MAKE_HX_RESULT(1,SS_RTSP,24)    // 80040698
#define HXR_PE_UNSUPPORTED_TRANSPORT                 MAKE_HX_RESULT(1,SS_RTSP,25)    // 80040699
#define HXR_PE_DESTINATION_UNREACHABLE               MAKE_HX_RESULT(1,SS_RTSP,26)    // 8004069a
#define HXR_PE_INTERNAL_SERVER_ERROR                 MAKE_HX_RESULT(1,SS_RTSP,27)    // 8004069b
#define HXR_PE_NOT_IMPLEMENTED                       MAKE_HX_RESULT(1,SS_RTSP,28)    // 8004069c
#define HXR_PE_BAD_GATEWAY                           MAKE_HX_RESULT(1,SS_RTSP,29)    // 8004069d
#define HXR_PE_SERVICE_UNAVAILABLE                   MAKE_HX_RESULT(1,SS_RTSP,30)    // 8004069e
#define HXR_PE_GATEWAY_TIMEOUT                       MAKE_HX_RESULT(1,SS_RTSP,31)    // 8004069f
#define HXR_PE_RTSP_VERSION_NOT_SUPPORTED            MAKE_HX_RESULT(1,SS_RTSP,32)    // 800406a0
#define HXR_PE_OPTION_NOT_SUPPORTED                  MAKE_HX_RESULT(1,SS_RTSP,33)    // 800406a1
#define HXR_RTSP_RESP_SINK_MESSAGE                   MAKE_HX_RESULT(0,SS_RTSP,34)    // 000406a2
...
#define HXR_AUDIO_DEV_CONN_TERMINATED   MAKE_HX_RESULT(1,SS_AUD,5)                  // 80040105
...
#define HXR_SOCK_NOTEMPTY               MAKE_HX_RESULT(1, SS_SOCK, 40)              // 80040628
#define HXR_SOCK_PROCLIM                MAKE_HX_RESULT(1, SS_SOCK, 41)              // 80040629
#define HXR_SOCK_USERS                  MAKE_HX_RESULT(1, SS_SOCK, 42)              // 8004062a
#define HXR_SOCK_DQUOT                  MAKE_HX_RESULT(1, SS_SOCK, 43)              // 8004062b
#define HXR_SOCK_STALE                  MAKE_HX_RESULT(1, SS_SOCK, 44)              // 8004062c
#define HXR_SOCK_REMOTE                 MAKE_HX_RESULT(1, SS_SOCK, 45)              // 8004062d
#define HXR_SOCK_SYSNOTREADY            MAKE_HX_RESULT(1, SS_SOCK, 46)              // 8004062e
#define HXR_SOCK_VERNOTSUPPORTED        MAKE_HX_RESULT(1, SS_SOCK, 47)              // 8004062f
#define HXR_SOCK_NOTINITIALISED         MAKE_HX_RESULT(1, SS_SOCK, 48)              // 80040630
#define HXR_SOCK_DISCON                 MAKE_HX_RESULT(1, SS_SOCK, 49)              // 80040631
#define HXR_SOCK_NOMORE                 MAKE_HX_RESULT(1, SS_SOCK, 50)              // 80040632
#define HXR_SOCK_CANCELLED              MAKE_HX_RESULT(1, SS_SOCK, 51)              // 80040633
#define HXR_SOCK_INVALIDPROCTABLE       MAKE_HX_RESULT(1, SS_SOCK, 52)              // 80040634
#define HXR_SOCK_INVALIDPROVIDER        MAKE_HX_RESULT(1, SS_SOCK, 53)              // 80040635
#define HXR_SOCK_PROVIDERFAILEDINIT     MAKE_HX_RESULT(1, SS_SOCK, 54)              // 80040636
#define HXR_SOCK_SYSCALLFAILURE         MAKE_HX_RESULT(1, SS_SOCK, 55)              // 80040637
#define HXR_SOCK_SERVICE_NOT_FOUND      MAKE_HX_RESULT(1, SS_SOCK, 56)              // 80040638
#define HXR_SOCK_TYPE_NOT_FOUND         MAKE_HX_RESULT(1, SS_SOCK, 57)              // 80040639
#define HXR_SOCK_E_NO_MORE              MAKE_HX_RESULT(1, SS_SOCK, 58)              // 8004063a
#define HXR_SOCK_E_CANCELLED            MAKE_HX_RESULT(1, SS_SOCK, 51)              // 80040633
#define HXR_SOCK_REFUSED                MAKE_HX_RESULT(1, SS_SOCK, 59)              // 8004063b
#define HXR_SOCK_HOST_NOT_FOUND         MAKE_HX_RESULT(1, SS_SOCK, 60)              // 8004063c
#define HXR_SOCK_TRY_AGAIN              MAKE_HX_RESULT(1, SS_SOCK, 61)              // 8004063d
#define HXR_SOCK_NO_RECOVERY            MAKE_HX_RESULT(1, SS_SOCK, 62)              // 8004063e
#define HXR_SOCK_NO_DATA                MAKE_HX_RESULT(1, SS_SOCK, 63)              // 8004063f
...
#define HXR_FMT_TOO_HIGH_RESOLUTION     MAKE_HX_RESULT(1, SS_FMT, 0)                // 80040700
#define HXR_FMT_AC3_IN_MKV              MAKE_HX_RESULT(1, SS_FMT, 1)                // 80040701
#define HXR_FMT_DTS_IN_MKV              MAKE_HX_RESULT(1, SS_FMT, 2)                // 80040702
#define HXR_FMT_AC3_IN_MP4              MAKE_HX_RESULT(1, SS_FMT, 3)                // 80040703
#define HXR_FMT_DTS_IN_MP4              MAKE_HX_RESULT(1, SS_FMT, 4)                // 80040704
#define HXR_FMT_AC3_IN_AVI              MAKE_HX_RESULT(1, SS_FMT, 5)                // 80040705
#define HXR_FMT_DTS_IN_AVI              MAKE_HX_RESULT(1, SS_FMT, 6)                // 80040706
#define HXR_FMT_MPEG2                   MAKE_HX_RESULT(1, SS_FMT, 7)                // 80040707
#define HXR_FMT_MULTI_CHANNEL_AAC       MAKE_HX_RESULT(1, SS_FMT, 8)                // 80040708
#define HXR_FMT_MULTI_CHANNEL_MP3       MAKE_HX_RESULT(1, SS_FMT, 9)                // 80040709
#define HXR_FMT_OUTOFRANGE              MAKE_HX_RESULT(1, SS_FMT, 10)               // 8004070a
