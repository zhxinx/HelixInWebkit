/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxcache.h,v 1.5.84.1 2012/05/03 03:09:37 shuohuang Exp $
 * 
...
DECLARE_INTERFACE_(IHXCacheFile, IUnknown)
{
    ...
    STDMETHOD(VerifyBlock)	(THIS_
				 HX_OFF_T	/*IN*/	hxBlockOffset,
				 HX_OFF_T	/*IN*/	hxBlockLength) PURE;
