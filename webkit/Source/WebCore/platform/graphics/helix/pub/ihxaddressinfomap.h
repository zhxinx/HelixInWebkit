 ...
 * 
 */
DEFINE_GUID(IID_IHXAddressInfoMap, 0xb936a2d6, 0x330d, 0x49c8, 0x9c, 0xde, 0x97, 0x68, 0xbe, 0xe3, 0xfe, 0x1e);
...
DECLARE_INTERFACE_(IHXAddressInfoMap, IUnknown)
{
    ...
    STDMETHOD(AddAddressInfo)           (THIS_
                                         const char* pKey,
                                         const UINT32 ulTime,
                                         const UINT32 ulCount,
                                         IHXSockAddr** ppInfo) PURE;

    STDMETHOD(LookupAddressInfo)        (THIS_
                                         const char* pKey,
                                         UINT32& ulTime,
                                         UINT32& ulCount,
                                         IHXSockAddr**& ppInfoOut) PURE;
