/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: stdarg.h,v 1.6.2.1.40.2 2010/09/28 02:19:52 ching_li Exp $
 * 
...
#if __GNUC__ > 4 || (4 == __GNUC__ && __GNUC_MINOR__ > 3)
#define DEFINE_NULL_VA_LIST   va_list Null_arg = {}
#define NULL_VA_LIST          Null_arg
#elif defined(VA_LIST_IS_STRUCT)
