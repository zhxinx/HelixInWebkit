/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: ctype.h,v 1.5.2.1 2008/01/18 09:33:08 vkathuria Exp $
 * 
...
#ifndef HLXSYS_CTYPE_H
#define HLXSYS_CTYPE_H

#ifdef _OPENWAVE_SIMULATOR
#ifndef _WIN32
#define _WIN32
#define CTYPE_UNDEF_WIN32
#endif /* _WIN32 */
...
#undef _WIN32
#undef CTYPE_UNDEF_WIN32
#endif /* CTYPE_UNDEF_WIN32 */

#ifdef _OPENWAVE_ARMULATOR
#define isascii(_c)   ( (unsigned)(_c) < 0x80 )
#endif

#endif /* HLXSYS_CTYPE_H */
