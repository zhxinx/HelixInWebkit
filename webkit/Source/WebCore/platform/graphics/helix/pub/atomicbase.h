/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: atomicbase.h,v 1.44.2.4 2009/02/26 01:37:15 sfu Exp $
 * 
...
/****************************************************************************
 *  $Id: atomicbase.h,v 1.44.2.4 2009/02/26 01:37:15 sfu Exp $
 *
 ...
 *
 * Implementation Notes:
 * This uses atomic routines from libc.  These atomic routines are available on 
 * Solaris 10 and an update of Solaris 9.
 * Also using Studio 10 compiler.
 */
#elif defined (_SOLARIS) && !defined (__GNUC__) && defined(_SOLARISX86)
#include <atomic.h>

#define HXAtomicIncUINT32(p)      atomic_add_32((uint32_t *)(p), 1)
#define HXAtomicDecUINT32(p)      atomic_add_32((uint32_t *)(p),-1)
#define HXAtomicIncRetUINT32(p)   atomic_add_32_nv((uint32_t *)(p), 1)
#define HXAtomicDecRetUINT32(p)   atomic_add_32_nv((uint32_t *)(p), -1)
#define HXAtomicAddUINT32(p,n)    atomic_add_32((uint32_t *)(p),(int32_t)(n))
#define HXAtomicSubUINT32(p,n)    atomic_add_32((uint32_t *)(p),(int32_t)(-n))
#define HXAtomicAddRetUINT32(p,n) atomic_add_32_nv((uint32_t *)(p),(int32_t)(n))
#define HXAtomicSubRetUINT32(p,n) atomic_add_32_nv((uint32_t *)(p),(int32_t)(-n))


#define HXAtomicIncINT32(p)      atomic_add_32((uint32_t *)(p), 1)
#define HXAtomicDecINT32(p)      atomic_add_32((uint32_t *)(p),-1)
#define HXAtomicIncRetINT32(p)   atomic_add_32_nv((uint32_t *)(p), 1)
#define HXAtomicDecRetINT32(p)   atomic_add_32_nv((uint32_t *)(p), -1)
#define HXAtomicAddINT32(p,n)    atomic_add_32((uint32_t *)(p),(int32_t)(n))
#define HXAtomicSubINT32(p,n)    atomic_add_32((uint32_t *)(p),(int32_t)(-n))
#define HXAtomicAddRetINT32(p,n) atomic_add_32_nv((uint32_t *)(p),(int32_t)(n))
#define HXAtomicSubRetINT32(p,n) atomic_add_32_nv((uint32_t *)(p),(int32_t)(-n))
 ...
 *
 */
#elif (defined(_MAC_UNIX) && defined(__ppc__)) || (defined(_LINUX) && defined(__powerpc__))
 ...
 *
 * Uses OStomic APIs, available on OS X 10.4 Tiger and later
 *
 */
#elif defined(_MAC_UNIX) && defined(__i386__)
...
HXAtomicIncRetUINT32(UINT32* pNum)
{
    return (UINT32)(OSAtomicIncrement32((int32_t*)pNum));
}

static inline UINT32
HXAtomicDecRetUINT32(UINT32* pNum)
{
    return (UINT32)(OSAtomicDecrement32((int32_t*)pNum));
}

static inline UINT32
HXAtomicAddRetUINT32(UINT32* pNum, UINT32 ulNum)
{
    return (UINT32)(OSAtomicAdd32((int32_t)ulNum, (int32_t*)pNum));
}
 ...
 * Implementation Notes:
 *
 * EVC++ doesn't do inline assembly; these are implemented in a seperate
 * file. Implementation is equal to the ARM/Linux code above, wrapping based
 * on AIX wrapping in this file.
 */
#elif defined (_ARM) && defined(_WINCE)

//defined in common/util/platform/armwince/atomicops.s
#if defined(__cplusplus)
extern "C" {
#endif
    INT32 _HXAtomicAddRetINT32   (INT32*  pNum, INT32  lNum);
