/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxsite2.h,v 1.9.2.5.26.3 2012/02/09 03:46:16 joeli Exp $
 * 
...
DECLARE_INTERFACE_(IHXSite5, IUnknown)
{
    ...
    STDMETHOD(DrawSubtitleHdr)		(THIS_	int type, IHXBuffer *data, UINT32 width = 0, UINT32 height = 0) PURE;
};
