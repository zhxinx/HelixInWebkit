/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxengin.h,v 1.34.2.3.6.2 2011/06/01 01:16:18 xzhao Exp $
 * 
 ...
 *  Interface:
 * 
 *	IHXSchedulerWaitEvent
 * 
 *  Purpose:
 *      Let all scheduler wait at a global event until next most recent CB in all scheduler's 
 *  normal queue is coming
 * 
 *  IID_IHXSchedulerWaitEvent
 *
 *     {d431e9ae-a48b-4e75-acbf-f88a46924fbc}
 * 
 */
DEFINE_GUID(IID_IHXSchedulerWaitEvent, 0xd431e9ae, 0xa48b, 0x4e75,
            0xac, 0xbf, 0xf8, 0x8a, 0x46, 0x92, 0x4f, 0xbc);
#undef  INTERFACE
#define INTERFACE  IHXSchedulerWaitEvent
DECLARE_INTERFACE_(IHXSchedulerWaitEvent, IUnknown)
{
    /*
     *  IUnknown methods
     */
    ...
    /*
     * IHXSchedulerWaitEvent methods
     */
    STDMETHOD_(UINT32, GetCBDueTimeInMs)    (THIS) PURE;
    STDMETHOD(SetWaitEvent)                 (THIS_
                                            IHXEvent* pEvent) PURE;
};
...
DEFINE_SMART_PTR(IHXSchedulerWaitEvent)
