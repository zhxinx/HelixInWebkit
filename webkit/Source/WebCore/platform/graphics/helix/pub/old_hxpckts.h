/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: old_hxpckts.h,v 1.13.84.1 2011/06/20 21:05:01 chrisyoung Exp $
 * 
...
class CHXPayloadExtPacket : public IHXPayloadExtPacket
{
public:
    CHXPayloadExtPacket();
    ...
    STDMETHOD(SetReplicatedData)                (THIS_ IHXBuffer* pBuffer);
    STDMETHOD_(IHXBuffer*,GetReplicatedData)    (THIS);

protected:
    INT32          m_lRefCount;
    CHXMultiPayloadPacket*     m_pPacket;
    IHXBuffer*		m_pReplicatedData;

    virtual ~CHXPayloadExtPacket();
};
