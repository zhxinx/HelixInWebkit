/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxpiids.h,v 1.60.2.4.38.3 2012/01/10 14:57:01 ching_li Exp $
 * 
...
#if ( !defined(_HXPHAND_H_) || !defined(HELIX_FEATURE_FULLGUID) )
 ...
 *  IID_IHXRTSPClientProtocol:		    {00000405-b4c8-11d0-9995-00a0248da5f0}
 *  IID_IHXRTSPClientProtocol2:		    {00000405-b4c8-11d0-9995-00a0248da5f1}
 */
...
DEFINE_GUID_ENUM(IID_IHXRTSPClientProtocol,		0x00000405, 0xb4c8, 0x11d0, 0x99, 0x95, 0x0, 0xa0, 0x24, 0x8d, 0xa5, 0xf0)
DEFINE_GUID_ENUM(IID_IHXRTSPClientProtocol2,		0x00000405, 0xb4c8, 0x11d0, 0x99, 0x95, 0x0, 0xa0, 0x24, 0x8d, 0xa5, 0xf1)
 ...
 */
#if ( !defined(_HXTSET_H_) || !defined(HELIX_FEATURE_FULLGUID) )
 ...
 *    IID_IHXListIterator
 */
#if ( !defined(_IHXLIST_H_) || !defined(HELIX_FEATURE_FULLGUID) )
 ...
 *    IID_IHXRTSPProtocol
 *    IID_IHXRTSPProtocolValuePass
 */
#if ( !defined(_HXRTSP2_H_) || !defined(HELIX_FEATURE_FULLGUID) )
...
DEFINE_GUID_ENUM(IID_IHXRTSPProtocolValuePass, 0x605c5422, 0x8f23, 0x4100, 0x85, 0x1f, 0x0, 0xa2, 0xa2, 0xe9, 0xdb, 0x29)
#endif
 ...
 *    IID_IHXSDP
 */
#if ( !defined(_HXSDP_H_) || !defined(HELIX_FEATURE_FULLGUID) )
...
#if ( !defined(_HXLISTP_H_) || !defined(HELIX_FEATURE_FULLGUID) )
 ...
 *    IID_
 */
#if ( !defined(_HXMMS2_H_) || !defined(HELIX_FEATURE_FULLGUID) )
 ...
 *
 */
#if ( !defined(MMSRSEND_H) || !defined(HELIX_FEATURE_FULLGUID) )
...
DEFINE_GUID_ENUM(IID_IHXAudioDecoderRenderer,
 ...
 * File: hxhttp.h
 */
#if ( !defined(_IHXHTTP_H_) || !defined(HELIX_FEATURE_FULLGUID) )
...
// Needs cleanup. These are also defined in player/hxclientkit/ihxclientrecordservice.h
DEFINE_GUID_ENUM(IID_IHXClientRecordService, 0x17f3f888, 0x8a1c, 0x48bd, 0xbf, 0x36, 0x3d, 0xc6, 0xdb, 0x4c, 0x57, 0x94)
DEFINE_GUID_ENUM(IID_IHXClientRecordService2, 0x17f3f888, 0x8a1c, 0x48bd, 0xbf, 0x36, 0x3d, 0xc6, 0xdb, 0x4c, 0x57, 0x95)
DEFINE_GUID_ENUM(IID_IHXRecordAdviseSink, 0x17f3f888, 0x8a1d, 0x48bd, 0xbf, 0x36, 0x3d, 0xc6, 0xdb, 0x4c, 0x57, 0x94)

DEFINE_GUID_ENUM(IID_IHXClientRecordFile, 0xea3b3159, 0xe6e6, 0x458b, 0xb3, 0x87, 0x86, 0x67, 0x14, 0x37, 0x3d, 0x5a)
DEFINE_GUID_ENUM(IID_IHXEncryptedClientRecordFile, 0xdb08ae93, 0x7d6b, 0x4208, 0xab, 0x5c, 0x9e, 0x87, 0xd5, 0x52, 0xa9, 0x92)
DEFINE_GUID_ENUM(IID_IHXClientRecordMetaURLFixer, 0x292f7f14, 0xd941, 0x4fe8, 0x82, 0x75, 0x78, 0x48, 0x2d, 0xf6, 0x69, 0xa8)

/*
 * File:        hxstats.h
 */

DEFINE_GUID_ENUM(IID_IHXClipStats, 0x2772b170, 0x3dd4, 0x43f9, 0x9e, 0xc6, 0x89, 0xa5, 0xb, 0x33, 0x83, 0x89)
DEFINE_GUID_ENUM(IID_IHXSessionStats, 0x3c02c47f, 0x6f44, 0x47fd, 0xb6, 0x25, 0xc8, 0x1a, 0x2b, 0xf0, 0x5d, 0x4f)
DEFINE_GUID_ENUM(IID_IHXSessionStats2, 0xa5d172eb, 0x47bc, 0x4ee4, 0xaa, 0x40, 0xe8, 0x72, 0xc2, 0x89, 0x1a, 0x54)
DEFINE_GUID_ENUM(IID_IHXSessionStats3, 0x82249cc6, 0xf020, 0x44cb, 0xb2, 0x80, 0x33, 0x4e, 0x62, 0x74, 0x29, 0x9c)
DEFINE_GUID_ENUM(IID_IHXCheckRetainEntityForSetup, 0x7ec159c4, 0xd9ed, 0x4e58, 0xb8, 0x95, 0x6c, 0xba, 0x38, 0xd5, 0x92, 0xf4)
...
DEFINE_GUID_ENUM(IID_IHXRateSelectionInfo, 0xffacb639, 0xaecf, 0x4111, 0xa1, 0xfb, 0x92, 0xf0, 0x85, 0x9d, 0x4f, 0xf)
 ...
 *
 * Description:
 *      Interface for data reading from a source. 
 */

DEFINE_GUID_ENUM(IID_IHXMMFDataSource,
0x2650fe34, 0xa181, 0x487c, 0xa3, 0x2d, 0x30, 0x35, 0x60, 0x18, 0xb3, 0x80)

/* File:
 *      ihxdownloadeventobserver.h
 *
 * Description:
 *      Interface for receiving events from an external download manager.
 */
...
DEFINE_GUID_ENUM(IID_IHXWMPlayReadyExt, 0x5482e822, 0x7b69, 0x46fe, 0x9d, 
			                       0xb8, 0x3f, 0x99, 0xf4, 0x3d, 0x60, 0xe8)
