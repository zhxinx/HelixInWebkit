/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cpacemkr.h,v 1.9.84.1 2010/10/21 06:11:33 scaijun Exp $
 * 
...
public:
    ...
    STDMETHOD(WaitForHibernate)	(THIS);
