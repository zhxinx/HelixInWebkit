/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: ihxpckts.h,v 1.16.62.2 2011/06/20 21:05:03 chrisyoung Exp $
 * 
...
/*
* when fix the bug 15138: Noise happens in the end of the audio. 
* root cause: the number of the frameblock of the last packet is FinalFrameBlocks 
* and the number of the frameblock of others packet is BlocksPerFrame.
* a packet gotten from apefileformat, is set a flag to mark the last packet or not.
* this flag can be used by decoder to set the proper parameter.
*/
#define HX_ASM_LAST_PACKET  0x20
 ...
 *
 *      
 *      This interface allows a packet to hold Replicated Data. 
 *      
 *
 *  IID_IHXPayloadExtPacket:
 *
 *      {03F2C951-93CF-43E3-81ED-92D3A428DC32}
 *
 */
DEFINE_GUID(IID_IHXPayloadExtPacket, 0x0003f2c951, 0x93cf, 0x43e3, 0x81, 
			0xed, 0x92, 0xd3, 0xa4, 0x28, 0xdc, 0x32);

/*
 *  The IHXCommonClassFactory supports creating an instance
 *  of this object.
 */
#define CLSID_IHXPayloadExtPacket IID_IHXPayloadExtPacket

#undef  INTERFACE
#define INTERFACE   IHXPayloadExtPacket

DECLARE_INTERFACE_(IHXPayloadExtPacket, IHXMultiPayloadPacket)
{
    /* IUnknown methods */
    STDMETHOD(QueryInterface)   (THIS_ REFIID riid, void** ppvObj) PURE;
    STDMETHOD_(ULONG32,AddRef)  (THIS) PURE;
    ...
    /* IHXPayloadExtPacket methods */
    STDMETHOD(SetReplicatedData)                (THIS_ IHXBuffer* pBuffer) PURE;
    STDMETHOD_(IHXBuffer*,GetReplicatedData)    (THIS) PURE;
};
