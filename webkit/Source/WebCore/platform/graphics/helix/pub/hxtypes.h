/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxtypes.h,v 1.36.2.5.28.2 2012/05/03 03:09:38 shuohuang Exp $
 *
...
#if defined(_LONG_IS_64) || defined(_WIN64) || defined(HELIX_FEATURE_64_BIT_FILE_SUPPORT)
#define HX_MAX_OFF_T MAX_INT64
#else
#define HX_MAX_OFF_T MAX_INT32
#endif
