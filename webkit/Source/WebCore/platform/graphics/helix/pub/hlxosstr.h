/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hlxosstr.h,v 1.10.2.5 2009/10/13 18:59:06 umakantg Exp $
 * 
...
public:
    ...
    HLXOsStrW(BYTE* uni, size_t length = (size_t)-1, int nUnitSize = 2, ENCODING_TYPE encType = LE);
