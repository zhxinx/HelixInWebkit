/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxplugn.h,v 1.16.2.1 2009/05/06 04:09:52 jain_1982s Exp $
 * 
...
typedef _INTERFACE  IHXPlugin2			    IHXPlugin2;
...
#define PLUGIN_REGKEY_MOUNTPOINT    "MountPoints"
 ...
 *  IID_IHXPlugin2:
 * 
 *	{00000C00-0901-11d1-8B06-00A024406D5a}
 * 
 */

DEFINE_GUID(IID_IHXPlugin2, 0x00000C00, 0x901, 0x11d1, 0x8b, 0x6, 0x0, 
			0xa0, 0x24, 0x40, 0x6d, 0x5a);

#undef  INTERFACE
#define INTERFACE   IHXPlugin2

DECLARE_INTERFACE_(IHXPlugin2, IUnknown)
{
    /*
     *	IUnknown methods
     */
...
DEFINE_SMART_PTR(IHXPlugin2)
DEFINE_SMART_PTR(IHXPluginEnumerator)
DEFINE_SMART_PTR(IHXPluginGroupEnumerator)
DEFINE_SMART_PTR(IHXPluginSearchEnumerator)
DEFINE_SMART_PTR(IHXPluginReloader)
DEFINE_SMART_PTR(IHXPluginFactory)
DEFINE_SMART_PTR(IHXPluginChallenger)
DEFINE_SMART_PTR(IHXPluginQuery)
DEFINE_SMART_PTR(IHXGenericPlugin)
DEFINE_SMART_PTR(IHXPlugin2Handler)
DEFINE_SMART_PTR(IHXPluginHandler3)
DEFINE_SMART_PTR(IHXPluginDatabase)
