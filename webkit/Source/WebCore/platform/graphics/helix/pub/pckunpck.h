/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: pckunpck.h,v 1.22.2.4.2.2 2011/04/01 03:59:13 henryxing Exp $
 * 
...
// the IHXCommonClassFactory it QI's the pContext
// to get.
HX_RESULT CreateRTPPacketCCF(REF(IHXRTPPacket*) rpPacket,
                          IUnknown*       pContext);
...
// Pack a UINT24 in little-endian format
HX_RESULT PackUINT24LE(BYTE* pBuf, UINT32 ulLen, UINT32 ulVal);
// Pack a UINT24 in little-endian format and advance the buffer
HX_RESULT PackUINT24LEInc(BYTE** ppBuf, UINT32* pulLen, UINT32 ulVal);
// Pack a UINT32 in big-endian format
