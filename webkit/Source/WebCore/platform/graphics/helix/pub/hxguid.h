/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxguid.h,v 1.11.2.1 2008/01/18 04:28:22 vkathuria Exp $
 * 
...
#if defined _MACINTOSH || defined _UNIX || defined _SYMBIAN || defined _OPENWAVE || defined _WINCE || defined _BREW
