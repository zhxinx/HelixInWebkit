/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxassert.h,v 1.22.2.2 2008/07/03 15:54:57 gwright Exp $
 * 
...
#if defined (_WINDOWS)
__inline void __cdecl HXTraceNull(const char* x, ...) {}
#else
static __inline void HXTraceNull(const char* x, ...) {}
#endif

#define HX_TRACE             HXTraceNull
#define HX_TRACE_SAFESTRING  HXTraceNull
