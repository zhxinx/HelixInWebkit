/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxrendr.h,v 1.12.2.1.44.3 2012/02/09 03:48:08 joeli Exp $
 * 
 ...
 *	IHXSubtitleRenderer
 *  Purpose:
 *	Interface exposed for controlling the subtile display
 *  IID_IHXSubtitleRenderer:
 *      {52815256-c88d-4dfd-9d65-77f1ad323a96}
 */

DEFINE_GUID(IID_IHXSubtitleRenderer, 0x52815256, 0xc88d, 0x4dfd, 0x9d, 0x65, 0x77, 0xf1, 0xad, 0x32, 0x3a, 0x96);

#undef  INTERFACE
#define INTERFACE   IHXSubtitleRenderer

DECLARE_INTERFACE_(IHXSubtitleRenderer, IUnknown)
{
    STDMETHOD(QueryInterface)		(THIS_
					REFIID riid,
					void** ppvObj) PURE;
    ...
    STDMETHOD_(HX_RESULT,ShowSubtitle)(THIS_ HXBOOL) PURE;
    STDMETHOD_(HX_RESULT,ClearSubtitle) (THIS) PURE;
    STDMETHOD_(HX_RESULT,SetSubtitleColor)(THIS_ UINT32 color) PURE;
};
