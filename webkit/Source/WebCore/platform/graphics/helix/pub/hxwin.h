/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxwin.h,v 1.11.2.1.44.2 2011/07/14 03:29:22 xzhao Exp $
 * 
...
// $Private:
/****************************************************************************
 *  Interface:  IHXSurfaceBufferKiller
 *  Purpose:    Interface to release hw decoder buffers used by site/surface.
 *  {E05E305E-EC9B-4173-AF87-1994E347E782}
 */
DEFINE_GUID(IID_IHXSurfaceBufferKiller, 0xe05e305e, 0xec9b, 0x4173, 0xaf, 
            0x87, 0x19, 0x94, 0xe3, 0x47, 0xe7, 0x82);

#undef  INTERFACE
#define INTERFACE  IHXSurfaceBufferKiller
DECLARE_INTERFACE_(IHXSurfaceBufferKiller, IUnknown)
{
    /************************************************************************
     *	Method:     ReleaseSurfaceDestBuffers()
     *	Purpose:    Release hw decoder buffers used by site/surface 
     */
    STDMETHOD(ReleaseSurfaceDestBuffers)    (THIS) PURE;
};
// $EndPrivate.

/****************************************************************************
 *  Interface:  IHXSurfaceQuery
 *  Purpose:    Interface to query surface
 *  {3786f3bd-5d5a-4cb6-a19e-860d7d174636}
 */
DEFINE_GUID(IID_IHXSurfaceQuery, 0x3786f3bd, 0x5d5a, 0x4cb6,
            0xa1, 0x9e, 0x86, 0x0d, 0x7d, 0x17, 0x46, 0x36);

#undef  INTERFACE
#define INTERFACE  IHXSurfaceQuery
DECLARE_INTERFACE_(IHXSurfaceQuery, IUnknown)
{
    /************************************************************************
     *	Method:     GetVideoSurface
     *	Purpose:    Get pointer of video surface
     */
    STDMETHOD(GetVideoSurface)    (THIS_ void** ppVideoSurface) PURE;
};
...
DEFINE_SMART_PTR(IHXSurfaceBufferKiller)
DEFINE_SMART_PTR(IHXSurfaceQuery)
