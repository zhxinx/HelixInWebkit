/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: ihxtlogsystem.h,v 1.38.2.12.6.2 2011/05/25 07:41:14 kliu Exp $
 * 
...
enum EHXTLogFuncArea
{
    ...
    ,HXLOG_AVCM = HX_MAKE4CC('A','V','C','M')  // MainConcept-based H.264 decoder
    ,HXLOG_MKVF = HX_MAKE4CC('M','K','V','F')  // Matroska file format
    ,HXLOG_RVXV = HX_MAKE4CC('R','V','X','V')  // Real Video Decoder
    ,HXLOG_MPTS = HX_MAKE4CC('M','P','T','S')  // MPEG-2 Transport Stream
    ,HXLOG_MPGV = HX_MAKE4CC('M','P','G','V')  // MPEG-1/2 video decoder
};
...
} g_ClientLogging4CCList[] =
{
    ...
    {HXLOG_MPGV, "MPEG-1/2 Video Decoder"},
