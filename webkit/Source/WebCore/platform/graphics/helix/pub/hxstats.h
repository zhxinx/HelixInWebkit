/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxstats.h,v 1.27 2007/08/07 00:11:50 seansmith Exp $
 * 
...
DECLARE_INTERFACE_(IHXClipStats, IUnknown)
{
    ...
    STDMETHOD_(UINT32, GetStartTime)        (THIS) PURE;
    STDMETHOD(SetStartTime)                 (THIS_ UINT32 ulStartTime) PURE;

    STDMETHOD_(UINT32, GetEndTime)          (THIS) PURE;
    STDMETHOD(SetEndTime)                   (THIS_ UINT32 ulEndTime) PURE;
    ...
    STDMETHOD(SetRRFrequency)               (THIS_ UINT32 ulRRFrequency) PURE;

    STDMETHOD_(UINT32, GetRTT)              (THIS) PURE;
    STDMETHOD(SetRTT)                       (THIS_ UINT32 ulRTT) PURE;
