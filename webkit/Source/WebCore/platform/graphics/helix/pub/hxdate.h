/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxdate.h,v 1.4.2.1 2008/01/18 07:41:06 vkathuria Exp $
 * 
...
// datetime points to a structure that is allocated to receive the date and time
