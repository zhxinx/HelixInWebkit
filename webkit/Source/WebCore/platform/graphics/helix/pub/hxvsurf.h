/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxvsurf.h,v 1.3.2.2.6.2 2011/11/03 09:59:16 ching_li Exp $
 * 
...
#ifdef HELIX_FEATURE_ORIENTABLE
/****************************************************************************
 *
 *  Interface:
 *
 *  IHXOrientableSurface
 *
 *  Purpose:
 *
 *  Interface for IHXOrientableSurface objects.
 *
 *  IHXOrientableSurface:
 *
 *  {a791086C-46C5-4f12-893C-83498E5A490B}
 *
 */
 
DEFINE_GUID(IID_IHXOrientableSurface, 0x00002207, 0x901, 0x11d1, 0x8b,
    0x6, 0x0, 0xa0, 0x24, 0x40, 0x6d, 0x59);

#undef  INTERFACE
#define INTERFACE   IHXOrientableSurface
DECLARE_INTERFACE_(IHXOrientableSurface, IUnknown)
{
    /************************************************************************
     *  Method:
     *      IHXOrientableSurface::SetRotation
     *  Purpose:
     *      Called by renderer to set rotation.
     */
    STDMETHOD_(void, SetRotation)(THIS_ UINT16 uRotation) PURE;
};
#endif // HELIX_FEATURE_ORIENTABLE
...
DEFINE_GUID(IID_IHXSubtitleSurface, 0x00002206, 0x901, 0x11d1, 0x8b,
    0x6, 0x0, 0xa0, 0x24, 0x40, 0x6d, 0x59);
