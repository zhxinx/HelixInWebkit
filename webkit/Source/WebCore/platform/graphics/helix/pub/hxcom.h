/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxcom.h,v 1.33.2.1.2.1 2011/08/02 08:38:21 joeli Exp $
 * 
...
#ifndef ENTRYPOINTCALLTYPE
#if defined(HELIX_CONFIG_SYMBIAN_GENERATE_MMP)
#define ENTRYPOINTCALLTYPE          EXPORT_C
#else
#define ENTRYPOINTCALLTYPE
#endif
#endif
...
#if !defined(INITGUID) || (defined(_STATICALLY_LINKED) && !defined(NCIHACK)) || defined(HXCOM_NO_QIFIND_DEFINE)
